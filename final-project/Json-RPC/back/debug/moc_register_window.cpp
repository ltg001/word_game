...
#include "../../client-back/register_window.h"
...
QT_MOC_LITERAL(2, 33, 0) // ""
    ...
    "register_window\0on_OKBtn_clicked\0"
};
...
void register_window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        register_window *_t = static_cast<register_window *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject register_window::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_register_window.data,
