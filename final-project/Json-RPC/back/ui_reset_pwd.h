/********************************************************************************
** Form generated from reading UI file 'reset_pwd.ui'
**
...
#ifndef UI_RESET_PWD_H
#define UI_RESET_PWD_H
...
public:
    ...
    void setupUi(QDialog *reset_pwd)
    {
        if (reset_pwd->objectName().isEmpty())
            reset_pwd->setObjectName(QStringLiteral("reset_pwd"));
        reset_pwd->resize(474, 367);
        reset_pwd->setStyleSheet(QLatin1String("/* ---------------------------------------------------------------------------\n"
"\n"
...
"  background-col"
                        "o"));
        gridLayoutWidget = new QWidget(reset_pwd);
        gridLayoutWidget->setObjectName(QStringLiteral("gridLayoutWidget"));
        gridLayoutWidget->setGeometry(QRect(50, 30, 391, 241));
        ...
        level = new QLineEdit(gridLayoutWidget);
        level->setObjectName(QStringLiteral("level"));

        gridLayout->addWidget(level, 1, 1, 1, 1);

        exp = new QLineEdit(gridLayoutWidget);
        exp->setObjectName(QStringLiteral("exp"));

        gridLayout->addWidget(exp, 2, 1, 1, 1);

        count = new QLineEdit(gridLayoutWidget);
        count->setObjectName(QStringLiteral("count"));

        gridLayout->addWidget(count, 3, 1, 1, 1);

        new_pwd = new QLineEdit(gridLayoutWidget);
        new_pwd->setObjectName(QStringLiteral("new_pwd"));

        gridLayout->addWidget(new_pwd, 4, 1, 1, 1);

        horizontalLayoutWidget = new QWidget(reset_pwd);
        horizontalLayoutWidget->setObjectName(QStringLiteral("horizontalLayoutWidget"));
        horizontalLayoutWidget->setGeometry(QRect(100, 290, 261, 61));
        ...
        retranslateUi(reset_pwd);
        QObject::connect(cancel, SIGNAL(clicked()), reset_pwd, SLOT(close()));

        QMetaObject::connectSlotsByName(reset_pwd);
    } // setupUi

    void retranslateUi(QDialog *reset_pwd)
    {
        reset_pwd->setWindowTitle(QApplication::translate("reset_pwd", "Dialog", nullptr));
        label->setText(QApplication::translate("reset_pwd", "username", nullptr));
        label_3->setText(QApplication::translate("reset_pwd", "exp", nullptr));
        label_2->setText(QApplication::translate("reset_pwd", "level", nullptr));
        label_5->setText(QApplication::translate("reset_pwd", "new password", nullptr));
        label_4->setText(QApplication::translate("reset_pwd", "question_count", nullptr));
        OKBtn->setText(QApplication::translate("reset_pwd", "OK", nullptr));
        cancel->setText(QApplication::translate("reset_pwd", "Cancel", nullptr));
    } // retranslateUi

};

namespace Ui {
    class reset_pwd: public Ui_reset_pwd {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_RESET_PWD_H
